...
LOGGING_ROOT = config("LOGGING_ROOT", default=STORAGE_DIR / "logs")
...
STATIC_URL = "/static/"
STATIC_ROOT = config("STATIC_ROOT", default=STORAGE_DIR / "static")
STATICFILES_DIRS = [
...
WEBOBS_UPDATE_EVENT_DELAY = config("WEBOBS_UPDATE_EVENT_DELAY", default=10, cast=int)

WAVEVIEW_HOST = config("WAVEVIEW_HOST", default="127.0.0.1:8444")
