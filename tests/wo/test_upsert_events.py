...
class UpsertEventsTest(unittest.TestCase):
    ...
    def test_upsert_events(self):
        ...
        if not cicd:
            warnings.warn(
                "You are running test_upsert_events() "
        ...
        event_2021_07_2380 = query.get_bulletin_by_id(engine, Bulletin, "2021-07#2380")
        ...
        event_2021_07_2392 = query.get_bulletin_by_id(engine, Bulletin, "2021-07#2392")
        ...
        event_2021_07_2382 = query.get_bulletin_by_id(engine, Bulletin, "2021-07#2382")
